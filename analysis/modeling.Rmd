...
models_set = workflow_set(
  preproc = list(dummy_basic = dummy_basic,
                 dummy_normalized = dummy_normalized,
                 encode_basic = encode_basic,
...
best_model = resample_res %>% 
  pull_workflow_set_result("encode_lasso") %>% 
  select_best(metric = "rmse")

pred = resample_res %>% 
  pull_workflow("encode_lasso") %>% 
...
test_set_transformed %>% 
  ...
  select(lnwage = .pred)) %>% 
  write_csv("C:\\Users\\internet\\Desktop\\temp_lasso_encode.csv")
